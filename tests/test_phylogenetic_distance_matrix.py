...
class PhylogeneticDistanceMatrixShuffleTest(unittest.TestCase):
    ...
    def test_shuffle(self):
        ...
        # clear these out as these will be different
        pdc0._taxon_phylogenetic_path_edges = None
        pdc1._taxon_phylogenetic_path_edges = None
        pdc2._taxon_phylogenetic_path_edges = None
